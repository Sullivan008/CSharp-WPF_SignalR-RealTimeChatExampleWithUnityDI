...
using SullyTech.Wpf.Dialogs.Exception.Window.ViewModels.Mapping.Profiles.Infrastructure.Extensions.DependencyInjection;
...
public static class ServiceCollectionExtensions
{
    public static void AddExceptionDialogWindow(this IServiceCollection @this)
    {
        ...
        @this.AddExceptionDialogWindowSettingsViewModelMappingProfile();
