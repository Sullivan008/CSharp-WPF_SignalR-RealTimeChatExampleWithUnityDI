...
namespace App.Core.Extensions.Implementation.Enum;
...
public static class EnumExtensions
{
    ...
    private static TAttribute GetAttribute<TAttribute>(this System.Enum @this) where TAttribute : Attribute
    {
        ...
        Guard.Implementation.Guard.ThrowIfNull(attribute, nameof(attribute), $"{typeof(TAttribute).Name} attribute not defined in {type.Name} enum.");
